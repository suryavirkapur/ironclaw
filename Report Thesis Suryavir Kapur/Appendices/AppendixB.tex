...
This paper presents IronClaw, a self-hosted agent platform that separates
...
a shared protobuf protocol. Across three repetitive domains, dynamic synthesis
reduced billed input tokens by 53--61\% relative to having no synthesis while
preserving correctness. Firecracker contained all five evaluated host-resource
attacks, while the ordinary process baseline contained none, at the cost of a
6.08-second median cold start and a 512\,MiB configured guest-memory ceiling.
The contribution is a practical architecture and empirical methodology for
making runtime tool synthesis useful without collapsing the host trust boundary.
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Utility benchmarks for no synthesis versus dynamic synthesis.
    ...
    \begin{itemize}
        ...
        \item When synthesis reuse is sufficient to amortize creation.
